...
export class InventoryController {
  ...
  @Get("resources")
  listResources(@Query("categoryId") categoryId?: string, @Query("available") available?: string, @Query("search") search?: string) {
  ...
  updateResource(@Param("resourceId") resourceId: string, @Body() dto: UpdateResourceDto) {
  ...
  createCopy(@Param("resourceId") resourceId: string, @Body() dto: CreateCopyDto) {
  ...
  updateCopyState(@Param("copyId") copyId: string, @Body() dto: UpdateCopyStateDto) {
  ...
  createObservation(@Param("copyId") copyId: string, @Body() dto: CreateCopyObservationDto) {
